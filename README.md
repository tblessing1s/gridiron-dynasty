...
Every battle opens on a **matchup screen**: both seven-man lineups with stat bars, the stakes, a home-crowd modifier when the territory is a Stadium or Capital (the attacker's throw scatter is wider live, or completions are lower in SIM/auto-resolve), a scouting line naming the weakest blocker-vs-rusher matchup and its pocket time, and a TAG button to mark one player as your franchise tag. From there you play, watch, sim, or auto-resolve. During the battle a **border bar** under the score shows the line of scrimmage as the frontier between the two empires and moves live with the ball carrier.
